...
void func(unsigned x){
    ...
    if(quadindex==0){
        for(i=0; i<9; i++) if(grid[i/3][i%3]) list[grid[i/3][i%3]-1]=0;
    }
    else if(quadindex==1){
       for(i=0; i<9; i++) if( grid[i/3][i%3+3]) list[grid[i/3][i%3+3]-1]=0;
    }
    else if(quadindex==2){
       for(i=0; i<9; i++) if( grid[i/3][i%3+6]) list[grid[i/3][i%3+6]-1]=0;
    }
    else if(quadindex==3){
       for(i=0; i<9; i++) if( grid[i/3+3][i%3]) list[grid[i/3+3][i%3]-1]=0;
    }
    else if(quadindex==4){
       for(i=0; i<9; i++) if( grid[i/3+3][i%3+3]) list[grid[i/3+3][i%3+3]-1]=0;
    }
    else if(quadindex==5){
       for(i=0; i<9; i++) if( grid[i/3+3][i%3+6]) list[grid[i/3+3][i%3+6]-1]=0;
    }
    else if(quadindex==6){
       for(i=0; i<9; i++) if( grid[i/3+6][i%3]) list[grid[i/3+6][i%3]-1]=0;
    }
    else if(quadindex==7){
       for(i=0; i<9; i++) if( grid[i/3+6][i%3+3]) list[grid[i/3+6][i%3+3]-1]=0;
    }
    else if(quadindex==8){
       for(i=0; i<9; i++) if( grid[i/3+6][i%3+6]) list[grid[i/3+6][i%3+6]-1]=0;
    }
